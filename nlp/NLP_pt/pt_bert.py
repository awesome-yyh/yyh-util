...
class BertClassify(nn.Module):
    ...
    def forward(self, X):
        ...
        # pooler_output: 
            ...
            # 通常用于句子分类
            # 对hidden_states做平均池化可能比pooler_output更好地代表句子
        # hidden_states: 
            # 可选的输出, tuple, 13个元素
...
if __name__ == '__main__': # 这个地方可以解决多线程的问题
    ...
    train_dataloader = Data.DataLoader(dataset=MyDataset(sentences, labels),
                                 batch_size=batch_size, shuffle=True, num_workers=1)
    
    train_features = next(iter(train_dataloader))
    print("查看数据:", train_features)

    sentences = ["我不喜欢打篮球", "这个相机很难看", "今天玩的特别伤心", "我喜欢你", "太棒了", "真是件令人高兴的事情"]
    labels = [0, 0, 0, 1, 1, 1]  # 1积极, 0消极.
    valid_dataloader = Data.DataLoader(dataset=MyDataset(sentences, labels),
